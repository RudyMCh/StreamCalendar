 ...
 */
final class Version20190619093257 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, password VARCHAR(60) NOT NULL, email VARCHAR(320) NOT NULL, active SMALLINT NOT NULL, type SMALLINT NOT NULL, token VARCHAR(32) DEFAULT NULL, INDEX IDX_8D93D649A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
