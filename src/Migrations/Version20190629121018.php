 ...
 */
final class Version20190629121018 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD color VARCHAR(20) DEFAULT NULL');
        $this->addSql('ALTER TABLE event ADD color VARCHAR(7) DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD token_in_process VARCHAR(32) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity DROP color');
        $this->addSql('ALTER TABLE event DROP color');
        $this->addSql('ALTER TABLE user DROP token_in_process');
    }
}
